...
const createStringBoolSchema = (opts) => {
	return z.preprocess((val) => val ?? getEnv(opts.envvar), StringBoolSchema).default(opts.default);
};
const PluginOptionsSchema = z.object({
	launchPath: z.preprocess((val) => {
		if (val === "auto" || val === "nightly") return autoBinPath(platform, val ?? "auto");
		return val;
	}, z.string().optional()),
...
//#endregion
export { EleventyPluginOpenSCAD, SCAD_BINS, addOpenSCADPlugin as addOpenSCADPlugin$1 };